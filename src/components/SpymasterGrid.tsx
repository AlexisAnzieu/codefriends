      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 mt-1">Spymaster View</p>
          </div>
          ...
          <div className="flex gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white">{teamCounts.red || 0}</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-team-blue rounded"></div>
              <span className="text-white">{teamCounts.blue || 0}</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-team-neutral rounded"></div>
              <span className="text-white">{teamCounts.neutral || 0}</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-4 h-4 bg-team-black rounded border border-gray-600"></div>
              <span className="text-white">{teamCounts.black || 0}</span>
            </div>
          </div>
        </div>
            ...
            return (
              <div
                ...
                className={`
                  ...
                  border-4 ${teamBorders[gridCard.team]}
                `}
              >
                {/* Picture */}
                ...
                <div className="p-2 text-center bg-black/30">
                  ...
                  {card.number && <p className="text-white/70 text-xs">#{card.number}</p>}
                </div>
              </div>
            )
          })}
        ...
        <div className="mt-8 flex justify-center gap-8 text-sm">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-team-red rounded"></div>
            <span className="text-white">Team Red</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-team-blue rounded"></div>
            <span className="text-white">Team Blue</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-team-neutral rounded"></div>
            <span className="text-white">Neutral</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-team-black rounded border border-gray-600"></div>
